...
module  main_clock_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //main_clock_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  main_clock_altclkctrl_0  (
    inclk,
    outclk);
    ...
    main_clock_altclkctrl_0_sub  main_clock_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
